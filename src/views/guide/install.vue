<template>
    <i-article>
        <article>
            ...
            <i-code :title="title" lang="html" bg>{{ code.install.cdn }}</i-code>
            ...
            <i-code :title="title" lang="auto" bg>{{ code.install.demo }}</i-code>
            <Anchor title="NPM 安装" h2></Anchor>
            <p>推荐使用 npm 来安装，享受生态圈和工具带来的便利，更好地和 webpack 配合使用，当然，我们也推荐使用 ES2015。</p>
            <i-code :title="title" lang="auto" bg>{{ code.install.install }}</i-code>
